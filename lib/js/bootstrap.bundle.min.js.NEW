...
!function(t, e) {
    ...
    var m = {
        ...
        getSelectorFromElement: function(t) {
            ...
            let href = document.querySelector(`[href='${e}']`)
            // let tmp = e && href ? e : null
            return href
        },
        ...
        t.show = function() {
            ...
            !(t && (e = p(t).not(this._selector).data(ct)) && e._isTransitioning))) {
                ...
                !i.isDefaultPrevented()) {
                    ...
                    this._triggerArray.length && p(this._triggerArray).removeClass(vt).attr("aria-expanded", !0) && p('body').addClass('noscroll') && p('.navbar-toggler').addClass('open'),
                    ...
                    if (0 < i)
                        for (var o = 0; o < i; o++) {
                            var r = this._triggerArray[o]
                              , s = m.getSelectorFromElement(r);
                            if (null !== s)
                                p([].slice.call(document.querySelectorAll(s))).hasClass(mt) || p(r).addClass(vt).attr("aria-expanded", !1) && p('body').removeClass('noscroll') && p('.navbar-toggler').removeClass('open')
